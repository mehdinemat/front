...
const ArchiveService = () => {
  ...
  const { data: serviceData, isLoading: isLoadingData, mutate: mutateData, error: errorData } = useSWR(`services?page=${page}&size=10&status=archive`, fetcherGetMission)
        ...
        <section class="container px-4 mx-auto  m-2">
            ...
            <div class="sm:flex sm:items-center py-2 sm:justify-between">
              <div>
                <div class="flex items-center gap-x-3">
                  <h2 class="text-lg font-medium text-gray-800 ">سرویس های آرشیو</h2>
          ...
          <div class="mt-6 md:flex md:items-center justify-end align-baseline text-end">
            ...
            <div class="flex items-center gap-x-3 mr-2">
              <a href='/lists/add_archive_service'>
                  ...
                  <table class="min-w-full divide-y divide-gray-200  overflow-scroll">
                    <thead class="bg-gray-50 " style={{ direction: 'rtl' }}>
                      <tr>
                        ...
                        <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 text-right">شروع</th>
...
export default withLayout(<PanelLayout />)(ArchiveService)
