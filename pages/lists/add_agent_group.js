...
const Addagentgroup = () => {
  ...
  const { trigger: addAgentGroup, isMutating: isAddingAgentGroup } = useMutation(`amel_group`, createPost)


  useEffect(() => {
    console.log(yekta, name, 'this is yekta name')
  }, [yekta, name])
  ...
  useEffect(() => {
    console.log(usernames, 'this is usrenames')
  }, [usernames])

  const handleSubmitForm = ()=>{
    addAgentGroup({yekta ,name , keys:tags , usernames})
  }
      ...
      <div class='mb-4 border p-8 rounded bg-slate-50 rounded p-8'>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="flex w-full mx-3 mb-4  items-center border border-gray-300 bg-white">
            ...
            {
              usernames?.map((name) => (
                <span style={{ minWidth: '80px' }} class=" items-center mx-1 flex flex-col	  rounded-md bg-blue-100 px-2 my-1 py-2  text-sm text-blue-700 ring-1 ring-inset ring-blue-700/10">
...
export default withLayout(<PanelLayout />)(Addagentgroup)
